        ...
        <div class="page-header flex-wrap">
            ...
            <div class="header-right d-flex flex-wrap mt-md-2 mt-lg-0">
                <div class="d-flex align-items-center">
                    ...
                    <a class="pl-3 mr-4" href="/matapelajarans">
                        <p class="m-0">Mata Pelajaran</p>
                    </a>
                </div>
                <a href="{{ route('matapelajarans.create') }}" class="btn btn-primary mt-2 mt-sm-0 btn-icon-text">
                                        ...
                                        <td>
                                            <div class="row">
                                                <div class="col-md-2 mr-5">
                                                    <a href="/matapelajarans/{{ $item->mata_pelajaran_id }}/edit" class="btn btn-dark btn-icon-text">
                                                        <i class="mdi mdi-file-check btn-icon-prepend"></i> Edit
                                                    </a>
                                                </div>
                                                <div class="col-md-2">
                                                    <form action="/matapelajarans/{{ $item->mata_pelajaran_id }}" method="POST">
                                                        @method('DELETE')
                                                        @csrf
