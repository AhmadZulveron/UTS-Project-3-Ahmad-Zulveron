            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="POST" action="/matapelajarans/{{ $matapelajarans->mata_pelajaran_id }}">
                            @method('PUT')
                            @csrf
                            <div class="form-group">
                                <label for="exampleInputName1">Judul</label>
                                <input type="text" class="form-control" id="exampleInputName1" name="judul" placeholder="Judul" value="{{ old('judul', $matapelajarans->judul) }}"/>
                            </div>
