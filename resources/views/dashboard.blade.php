...
<div class="content-wrapper pb-0">
    <div class="page-header flex-wrap">
        <div class="header-left">
            <a href="/pendaftarans" class="btn btn-primary mb-2 mb-md-0 mr-2"> Pendaftaran Siswa </a>
    ...
    {{-- <div class="row">
        ...
        <div class="col-sm-6 stretch-card grid-margin">
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div class="card-title"> Conversions <small class="d-block text-muted">August
                                01 - August 31</small>
                        </div>
                        <div class="d-flex text-muted font-20">
                            <i class="mdi mdi-printer mouse-pointer"></i>
    ...
    {{-- <div class="row">
        <div class="col-sm-4 stretch-card grid-margin">
            <div class="card">
                <div class="card-body p-0">
                    <img class="img-fluid w-100" src="/images/dashboard/img_1.jpg" alt="" />
                </div>
        ...
        <div class="col-sm-4 stretch-card grid-margin">
            <div class="card">
                <div class="card-body p-0">
                    <img class="img-fluid w-100" src="/images/dashboard/img_2.jpg" alt="" />
                </div>
                <div class="card-body px-3 text-dark">
                    <div class="d-flex justify-content-between">
                        <p class="text-muted font-13 mb-0">ENTIRE APARTMENT</p>
        ...
        <div class="col-sm-4 stretch-card grid-margin">
            <div class="card">
                <div class="card-body p-0">
                    <img class="img-fluid" src="/images/dashboard/img_3.jpg" alt="" />
                </div>
                <div class="card-body px-3 text-dark">
                    <div class="d-flex justify-content-between">
                        <p class="text-muted font-13 mb-0">ENTIRE APARTMENT</p>
        ...
        <div class="col-xl-8 stretch-card grid-margin">
            <div class="card">
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table custom-table text-dark">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <img src="/images/faces/face2.jpg" class="mr-2"
                                ...
                                <tr>
                                    <td>
                                        <img src="/images/faces/face3.jpg" class="mr-2"
                                ...
                                <tr>
                                    <td>
                                        <img src="/images/faces/face4.jpg" class="mr-2"
                                ...
                                <tr>
                                    <td>
                                        <img src="/images/faces/face5.jpg" class="mr-2"
                                            alt="image" /> Ina Curry
                                    </td>
                                    <td>
                                        <div class="d-flex">
                                ...
                                <tr>
                                    <td>
                                        <img src="/images/faces/face7.jpg" class="mr-2"
                                ...
                                <tr>
                                    <td>
                                        <img src="/images/faces/face9.jpg" class="mr-2"
                    ...
                    <a class="text-black d-block pl-4 pt-2 pb-2 pb-lg-0 font-13 font-weight-bold"
                        href="#">Show more</a>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-6 col-xl-4 stretch-card grid-margin">
            <div class="card color-card-wrapper">
                <div class="card-body">
                    <img class="img-fluid card-top-img w-100" src="/images/dashboard/img_5.jpg"
                        alt="" />
